      ...
      <DefaultLayout
        ...
        sidebarContent={
          <nav className="flex flex-col gap-2">
            ...
            <a href="/access-requests" className="p-2 hover:bg-gray-700 rounded block text-gray-200 no-underline">Access Requests</a>
            <a href="/audit-logs" className="p-2 hover:bg-gray-700 rounded block text-gray-200 no-underline">Audit Logs</a>
          </nav>
        }
      >
        {children}
