      ...
      <DefaultLayout
        ...
        sidebarContent={
          <nav className="flex flex-col gap-2">
            ...
            <a href="/resources" className="p-2 hover:bg-gray-700 rounded block text-gray-200 no-underline">Resources</a>
            <a href="/allocations" className="p-2 hover:bg-gray-700 rounded block text-gray-200 no-underline">Allocations</a>
          </nav>
        }
      >
        {children}
